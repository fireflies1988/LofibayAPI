...
{
    public partial class CreateLofibayDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikedPhotos", x => new { x.UserId, x.PhotoId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_LikedPhotos_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotoCollections", x => new { x.PhotoId, x.CollectionId });
                    table.ForeignKey(
                        name: "FK_PhotoCollections_Collections_CollectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikedPhotos_PhotoId",
                table: "LikedPhotos",
                column: "PhotoId");

            migrationBuilder.CreateIndex(
                name: "IX_PhotoCollections_CollectionId",
